    ...
    def train(rng):
        ...
        def _update_step(runner_state, unused):
            ...
            def _env_step(runner_state, unused):
                ...
                # Don't batchify info - just store it as-is
                # The info dict structure will be preserved through the scan
            ...
            def _update_epoch(update_state, unused):
                ...
                # Separate info from the rest of the batch since it has irregular structure
                traj_batch_no_info = Transition(
                    ...
                    obs=traj_batch.obs,
                    info=None  # We'll keep info separate
                )
                ...
                # Restore the full traj_batch with info for the return value
