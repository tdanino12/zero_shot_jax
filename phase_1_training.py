    ...
    def train(rng):
        ...
        def _update_step(runner_state, unused):
            ...
            def _env_step(runner_state, unused):
                ...
                penalty = jax.random.lognormal(_rng, sigma=12, shape=reward["agent_0"].shape)
                mask = jax.random.bernoulli(_rng, p=0.2, shape=reward["agent_0"].shape)  # 30% probability
                # agent_0: env reward + shaped reward + empowerment reward
                reward["agent_0"] += info["shaped_reward"]["agent_0"]+penalty*mask
                ...
                emp_ready = jnp.float32(emp_state.buffer.buflen > config["batch_size"] * 10)
                #reward["agent_0"] = reward["agent_0"] -2*emp_reward #* emp_ready
...
if __name__ == "__main__":
    ...
    parser.add_argument("--update_epochs", type=int, default=40)#40)
    ...
    args.save = True
    args.pretrained_agent_path = os.path.join(os.getcwd(), "cramped_room/self_play")#"phase0/asymm_advantages/self_play")
